---
title: "Build OpenCV with CUDA and Python on Windows"
toc: true
date: 05/04/23
---
...
If you just need the Windows libraries or a Python Wheelt take a look at [OpenCV C++ CUDA Builds](https://github.com/cudawarped/opencv_contrib/releases) and/or [OpenCV python CUDA wheels](https://github.com/cudawarped/opencv-python-cuda-wheels/releases) to see if there is a pre-built version suitable for your setup.
...
1. Open windows command prompt, type **cmd** in the ~Windows earch bar.
...
2. Paste the below into to the command prompt and press **Enter**.
   ...
   [The default installation directory for mambaforge is **%userprofile%\\mambaforge**.]{.aside}
    ...
    Expand the tips below for an example of the output you should get in CMake if the configuration step is successful and other useful information.
...
## Full CMake cmd line for building with Ninja
